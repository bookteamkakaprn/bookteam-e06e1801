        ...
        <div className="text-center">
          ...
          <div className="mt-8 flex flex-wrap gap-3 justify-center">
            ...
            <Button asChild variant="outline" size="lg">
              <a href="#como">Conhecer trilhas</a>
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {pilares.map((p) => (
            <div
              key={p.title}
              className="rounded-xl border border-border/40 bg-white/5 p-6 backdrop-blur-sm hover:bg-white/10 transition-colors"
            >
          ...
          {testimonios.map((i, idx) => (
            ...
            >
              <div className="flex gap-0.5">
                {Array.from({ length: i.nota }).map((_, i) => (
...
function FaqSection() {
  const items = [
    ...
    },
    {
      ...
      a: "Ao concluir uma trilha (todos os encontros com presença registrada), o certificado é emitido pela administração.",
    },
    {
        ...
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-foreground/70">
              <li>
                <a href="#visao" className="hover:text-foreground">
                  Quem somos
                </a>
              </li>
              <li>
